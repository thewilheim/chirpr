export const TextPlaceholder = () => {
  return (
    <div className="max-w-lg animate-pulse">
      ...
      <div className="h-2 bg-gray-400 rounded-full dark:bg-gray-700 max-w-[930px] mb-2.5"></div>
...
export const ImagePlaceholder = ({width, height}:{width:string, height:string}) => {
  return (
    <div
      role="status"
      className={`space-y-8 animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse md:flex md:items-center ${width} ${height}`}
    >
      <div className={`flex items-center justify-center w-72 h-full bg-gray-400 rounded-2xl  drop-shadow  dark:bg-gray-700`}>
        <svg
